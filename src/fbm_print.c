...
// base_vram: Base VRAM Addr, bufferwidth: buffer-width per line,
...
/////////////////////////////////////////////////////////////////////////////
int fbm_printVRAM(void *base_vram, int bufferwidth, int x, int y, char *str, u32 color, u32 back, u8 fill, int rate, u32 pad)
{
	int i;
	int len;
	int index;
	...
	for (i = 0; i < loop; i++)
	{
        if (i < len)
        {
    		...
    		else
        	{
        		...
        		fbm_printSUB(base_vram, bufferwidth, index, isdouble,
...
// rate: Mix Rate (0-100 or -1--101)
/////////////////////////////////////////////////////////////////////////////
void fbm_printSUB(void *base_vram, int bufferwidth, int index, int isdouble, int height, int byteperline, u32 color, u32 back, u8 fill, int rate)
{
	int           i;
	int           j;
	int           shift;
...
//		nexty = 0;
	...
	base_vram = (u16 *)base_vram + nextx + nexty * bufferwidth;
	...
	for (i = 0; i < height; i++)
	{
		...
		base_vram = (u16 *)base_vram + bufferwidth;
	}
